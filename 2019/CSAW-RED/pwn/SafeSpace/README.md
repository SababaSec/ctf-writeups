...
We can start by finding the list of functions present in the compiled binary. [This Stack Overflow question](https://stackoverflow.com/questions/392142/) illustrates various methods to accomplish this.
